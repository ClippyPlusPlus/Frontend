<template>
  <div class="max-w-5xl mx-auto p-6 space-y-6">
    ...
    <div class="grid md:grid-cols-3 gap-4">
      ...
      <button @click="sendLocalSound('NotificationSpam')" :class="['transition duration-300 ease-in-out bg-gradient-to-r from-blue-400 to-teal-500 text-2xl text-teal-900 hover:text-teal-200 rounded px-6 py-12 hover:z-10 hover:shadow-lg', { 'hover:from-teal-500 hover:to-blue-600 transform hover:-translate-y-1 hover:scale-110': canSendMessage}]">
        Hé, een klusjesman 🛠️
      </button>
